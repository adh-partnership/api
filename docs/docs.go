...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/certifications": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Certification type data",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_v1_certifications.CertificationDTO"
                        }
                    }
                ],
                "responses": {
                    ...
                    "409": {
                        "description": "Conflict - certification name already in use",
                        "schema": {
                            "$ref": "#/definitions/response.R"
                        }
                    },
        ...
        "/v1/certifications/bulk-order": {
            "patch": {
                ...
                "parameters": [
                    {
                        "description": "Array of certification IDs in order",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/v1/certifications/{name}": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Current certification name",
                        "name": "name",
                        "in": "path",
                        "required": true
                    },
    ...
    "definitions": {
        ...
        "github.com_adh-partnership_api_internal_v1_certifications.CertificationDTO": {
            "type": "object",
            "properties": {
                "display_name": {
                    "type": "string"
        ...
        "internal_v1_certifications.CertificationDTO": {
            "type": "object",
            "properties": {
                "display_name": {
                    "type": "string"
