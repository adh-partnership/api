...
func TestConvUserToUserResponse(t *testing.T) {
	...
	user := &models.User{
		...
		DelCertification:  constants.CertificationTraining,
		GndCertification:  constants.CertificationMajor,
	...
	expectedResponse := &UserResponse{
		...
		Certiciations: UserResponseCertifications{
			Delivery: constants.CertificationTraining,
			Ground:   constants.CertificationMajor,
...
func TestPatchUserFromUserResponse(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			Patch: UserResponseAdmin{
				Certiciations: UserResponseCertifications{
					Delivery: constants.CertificationNone,
